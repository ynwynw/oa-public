package com.ynw.oa.common.utils.myThread;

import com.ynw.oa.common.utils.DateUtils;
import com.ynw.oa.common.utils.StringUtils;
import com.ynw.oa.project.po.*;
import com.ynw.oa.project.service.workTime.WorkTimeUtils;
import com.ynw.oa.project.mapper.AttendCountMapper;
import com.ynw.oa.project.mapper.AttendMapper;
import com.ynw.oa.project.mapper.LeaveFormMapper;
import com.ynw.oa.project.mapper.WorkTimeMapper;
...
//            }
    ...
    private static Map<String, Integer> getLateAttentCount(List<Attend> attends, WorkTime workTime)
    {
        ...
        //数据库的time类型 为1970年 拿到一个时间 要进行统一的时间戳的比对
