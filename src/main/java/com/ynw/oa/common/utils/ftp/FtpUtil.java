package com.ynw.oa.common.utils.ftp;
...
public class FtpUtil{
     ...
     * FTP服务器ip
     */
    private static final String host = "47.101.155.194";
    /**
     * FTP服务器端口
     */
     ...
     */
    private static final String basePath = "/usr/local/java/file";
    /**
     * FTP服务器文件存放路径。例如分日期存放：/2018/05/28。文件的路径为basePath+filePath
     */
    public static final String filePath = "http://47.101.155.194:8880";
