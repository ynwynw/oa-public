...
import com.ynw.oa.common.exception.file.FileNameLengthException;
import com.ynw.oa.common.exception.file.FileSizeException;
import com.ynw.oa.common.utils.HttpHeaderUtil;
import com.ynw.oa.common.utils.StringUtils;
import com.ynw.oa.common.utils.file.UploadFile;
import com.ynw.oa.common.utils.shiro.Encryption;
...
import com.ynw.oa.project.service.dept.IDeptService;
import com.ynw.oa.project.service.position.IPositionService;
import com.ynw.oa.project.service.role.IRoleService;
...
public class UserController extends BaseController {
    ...
    {
        if (StringUtils.isNotNull(user.getUid()) && !User.isBoss(getUserId()))
        {
    ...
    public AjaxResult addUser(User user)
    {
        ...
        user.setPwd(Encryption.getMD5(user.getPwd(), user.getUid()).toString());
